    ...
    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img src="{{asset('/images/WhatsApp Image 2022-01-21 at 08.13.06.jpeg')}}" class="d-block w-100"
                    alt="...">
            </div>
            <div class="carousel-item">
    ...
    <div class="container">
        ...
        <section class="penerimaan row">
            ...
            <div class="image col-lg-6 ms-auto">
                <div class="image-bg"
                    style="background-image: url(' https://source.unsplash.com/600x600?enrollment ') ;"></div>
            </div>
        </section>
        @else
        @endif
